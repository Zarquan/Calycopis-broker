...
class OptionBase(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'urn:enum-value-option': 'EnumValueOption','urn:integer-delta-option': 'IntegerDeltaOption','urn:integer-value-option': 'IntegerValueOption','urn:string-value-option': 'StringValueOption'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OptionBase failed to lookup discriminator value from " +
