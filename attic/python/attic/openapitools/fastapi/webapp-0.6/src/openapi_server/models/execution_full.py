...
class ExecutionFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["executable", "resources", "schedule", "offer", "execution"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExecutionFull from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExecutionFull from a dict"""
        if obj is None:
            return None
