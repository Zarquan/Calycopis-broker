...
class JupyterNotebook01(AbstractExecutable):
    ...
    type: StrictStr
    notebook: StrictStr = Field(description="The URL of the notebook. TODO - This needs to take into account different ways of referring to a notebook. ")
    __properties: ClassVar[List[str]] = ["ident", "name", "properties", "type", "notebook"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of JupyterNotebook01 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of JupyterNotebook01 from a dict"""
        if obj is None:
            return None
