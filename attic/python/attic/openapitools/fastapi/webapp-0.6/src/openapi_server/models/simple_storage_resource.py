...
class SimpleStorageResource(AbstractStorageResource):
    ...
    __properties: ClassVar[List[str]] = ["ident", "name", "properties", "type", "size"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SimpleStorageResource from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SimpleStorageResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "size": MinMaxInteger.from_dict(obj.get("size")) if obj.get("size") is not None else None
        })
        return _obj
