...
class StringValueOption(OptionBase):
    ...
    pattern: Optional[StrictStr] = Field(default=None, description="A regular expression pattern restricting the value. ")
    __properties: ClassVar[List[str]] = ["type", "path", "pattern"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StringValueOption from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StringValueOption from a dict"""
        if obj is None:
            return None
