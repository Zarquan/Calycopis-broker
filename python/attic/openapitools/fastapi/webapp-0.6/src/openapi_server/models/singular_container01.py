...
class SingularContainer01(AbstractExecutable):
    ...
    type: StrictStr
    image: StrictStr = Field(description="The URL to download the container image from. ")
    __properties: ClassVar[List[str]] = ["ident", "name", "properties", "type", "image"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SingularContainer01 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SingularContainer01 from a dict"""
        if obj is None:
            return None
