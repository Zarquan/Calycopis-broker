...
import net.ivoa.calycopis.datamodel.resource.compute.simple.SimpleComputeResourceEntityFactory;
import net.ivoa.calycopis.datamodel.resource.compute.simple.SimpleComputeResourceValidator;
