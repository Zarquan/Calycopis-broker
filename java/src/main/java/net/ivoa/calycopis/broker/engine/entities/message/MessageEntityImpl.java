...
public class MessageEntityImpl
    ...
    private ComponentEntityImpl parent;

    public ComponentEntityImpl getParent()
        {
        return this.parent;
        }

    public void setParent(final ComponentEntityImpl parent)
        {
        this.parent = parent;
        }
     ...
     * 
     */
    public MessageEntityImpl(final ComponentEntityImpl parent, final LevelEnum level, final String type, final String template, final Map<String, Object> values)
        {
        this.type = type;
        this.level = level;
        this.parent = parent;
