...
class IntegerDeltaOption(OptionBase):
    ...
    min: Optional[StrictInt] = Field(default=None, description="The minimum change that can be applied. ")
    max: Optional[StrictInt] = Field(default=None, description="The maximum change that can be applied. ")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IntegerDeltaOption from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IntegerDeltaOption from a dict"""
        if obj is None:
            return None
