...
class Repo2DockerContainer01(AbstractExecutable):
    ...
    type: StrictStr
    source: StrictStr = Field(description="The URL of the repository to package. ")
    __properties: ClassVar[List[str]] = ["ident", "name", "properties", "type", "source"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Repo2DockerContainer01 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Repo2DockerContainer01 from a dict"""
        if obj is None:
            return None
