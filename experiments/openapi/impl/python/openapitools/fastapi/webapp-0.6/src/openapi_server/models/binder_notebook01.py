...
class BinderNotebook01(AbstractExecutable):
    ...
    type: StrictStr
    repository: StrictStr = Field(description="The URL of the repository to package. ")
    notebook: Optional[StrictStr] = Field(default=None, description="The relative path of the notebook within the repository. ")
    __properties: ClassVar[List[str]] = ["ident", "name", "properties", "type", "repository", "notebook"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BinderNotebook01 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BinderNotebook01 from a dict"""
        if obj is None:
            return None
