...
class ExecutionStatusResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["offer", "execution", "executable", "resources", "schedule", "options"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "offer": OfferStatus.from_dict(obj.get("offer")) if obj.get("offer") is not None else None,
            "execution": ExecutionStatus.from_dict(obj.get("execution")) if obj.get("execution") is not None else None,
            ...
            "options": [OptionBase.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None
        })
        return _obj
