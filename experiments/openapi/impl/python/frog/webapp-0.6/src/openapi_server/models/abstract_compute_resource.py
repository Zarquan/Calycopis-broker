...
class AbstractComputeResource(AbstractPolymorph):
    ...
    def from_json(cls, json_str: str) -> Union[Self]:
        """Create an instance of AbstractComputeResource from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        """Create an instance of AbstractComputeResource from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("AbstractComputeResource failed to lookup discriminator value from " +
