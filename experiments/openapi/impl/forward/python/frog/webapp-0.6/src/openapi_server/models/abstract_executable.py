...
class AbstractExecutable(AbstractPolymorph):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'urn:binder-notebook-0.1': 'BinderNotebook01','urn:docker-container-0.1': 'DockerContainer01','urn:jupyter-notebook-0.1': 'JupyterNotebook01','urn:repo2docker-0.1': 'Repo2DockerContainer01','urn:single-container-0.1': 'SingularContainer01'
    }
    ...
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self]:
        """Create an instance of AbstractExecutable from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        """Create an instance of AbstractExecutable from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("AbstractExecutable failed to lookup discriminator value from " +
