...
class AbstractDataResource(AbstractPolymorph):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'urn:S3-data-resource': 'S3DataResource','urn:simple-data-resource': 'SimpleDataResource'
    }
    ...
    def from_json(cls, json_str: str) -> Union[Self, Self]:
        """Create an instance of AbstractDataResource from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        """Create an instance of AbstractDataResource from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("AbstractDataResource failed to lookup discriminator value from " +
